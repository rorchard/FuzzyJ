...
rem
rem  There are a number of Jess classes that could be removed after
rem  creating the jar file to get the size down. see docs on
rem  how to update a FuzzyJ distribution (FuzzyJCreation.doc)

d:\javasoft\jdk1.3\bin\jar -cf FuzzyShowerJessApplet.jar ^
         -C f:\fuzzyjtoolkit\ ^
         f:\fuzzyjtoolkit\examples\fuzzyshowerjess\*.clp ^
         f:\fuzzyjtoolkit\examples\fuzzyshowerjess\*.clp ^
         -C f:\fuzzyjtoolkit\bin\ ^
         f:\fuzzyjtoolkit\bin\examples\fuzzyshowerjess\*.class ^
         f:\fuzzyjtoolkit\bin\examples\fuzzyshowerjess\*.class ^
         f:\fuzzyjtoolkit\bin\examples\fuzzyshowerjess\*.class ^
...
d:\javasoft\jdk1.3\bin\jar -uf FuzzyShowerJessApplet.jar ^
         -C f:\fuzzyjtoolkit\bin\ ^
         ...
         -C f:\jess61a3\ ^
         f:\jess61a3\jess\Abs.class ^
         f:\jess61a3\jess\Abs.class ^
         f:\jess61a3\jess\*.class ^
         f:\jess61a3\jess\*.clp ^
         f:\jess61a3\jess\awt\TextReader.class ^
         f:\jess61a3\jess\factory\*.class ^
         f:\jess61a3\jess\FuzzyShowerJess.clp
