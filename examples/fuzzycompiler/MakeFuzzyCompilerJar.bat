...
d:\javasoft\jdk1.3\bin\jar -cf FuzzyCompilerApplet.jar ^
         -C f:\fuzzyjtoolkit\bin\ ^
         f:\fuzzyjtoolkit\bin\examples\fuzzycompiler\AboutDialog$SymAction.class ^
         f:\fuzzyjtoolkit\bin\examples\fuzzycompiler\AboutDialog$SymAction.class ^
         f:\fuzzyjtoolkit\bin\examples\fuzzycompiler\*.class ^
         f:\fuzzyjtoolkit\bin\java_cup\runtime\*.class ^
         f:\fuzzyjtoolkit\bin\nrc\fuzzy\CUP$FuzzyParser$actions.class ^
         f:\fuzzyjtoolkit\bin\nrc\fuzzy\AntecedentCombineOperatorInterface.class ^
         f:\fuzzyjtoolkit\bin\nrc\fuzzy\AntecedentCombineOperator.class ^
         f:\fuzzyjtoolkit\bin\nrc\fuzzy\MinimumAntecedentCombineOperator.class ^
         f:\fuzzyjtoolkit\bin\nrc\fuzzy\ProductAntecedentCombineOperator.class ^
         ...
         f:\fuzzyjtoolkit\bin\nrc\fuzzy\LarsenProductMaxMinRuleExecutor.class ^
