...
public class Parser {
    ...
    int compareFiles(File verifiedFile, File resultFile, File outFile)
    {
        int diffs = 0; // return # tests with differences
        try {
    ...
    public nrc.fuzzy.FuzzyValue convertToFuzzyValue(String s)
    {
        ...
        try {
            ...
            try
             ...
             {
               System.err.println("X value outside UOD in test value ...");
            ...
            System.err.println("X value out of order in test value ...");
            System.err.println(s);
            e.printStackTrace();
            System.exit(0);
            return null;
        } catch(nrc.fuzzy.YValueOutOfRangeException e){
            System.err.println("Y value out of range in test value ...");
            System.err.println(s);
            e.printStackTrace();
            System.exit(0);
            return null;
