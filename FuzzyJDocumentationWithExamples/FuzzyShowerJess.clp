...
(defrule init
  ...
  =>
   ...
   (?*tempFvar* addTerm "none" (new nrc.fuzzy.RFuzzySet 5.0 5.1 ?*rlf*))
   (?*tempFvar* addTerm "cold" (new nrc.fuzzy.TrapezoidFuzzySet 5.0 5.05 10.0 35.0))
   (?*tempFvar* addTerm "OK" (new nrc.fuzzy.PIFuzzySet 36.0 3.5))
   (?*tempFvar* addTerm "hot" (new nrc.fuzzy.SFuzzySet 37.0 60.0))
   (?*flowFvar* addTerm "none" (new nrc.fuzzy.RFuzzySet 0.0 0.05 ?*rlf*))
   (?*flowFvar* addTerm "low" (new nrc.fuzzy.TrapezoidFuzzySet 0.0 0.025 3.0 11.5))
   (?*flowFvar* addTerm "OK" (new nrc.fuzzy.PIFuzzySet 12.0 1.8))
   (?*flowFvar* addTerm "strong" (new nrc.fuzzy.SFuzzySet 12.5 25.0))
   (?*hotValveChangeFvar* addTerm "NB" (new nrc.fuzzy.RFuzzySet -0.5 -.25 ?*rlf*))
   (?*hotValveChangeFvar* addTerm "NM" (new nrc.fuzzy.TriangleFuzzySet -.35 -.3 -.15))
   (?*hotValveChangeFvar* addTerm "NS" (new nrc.fuzzy.TriangleFuzzySet -.25 -.15 0.0))
   (?*hotValveChangeFvar* addTerm "Z" (new nrc.fuzzy.TriangleFuzzySet -.05 0.0 0.05))
   (?*hotValveChangeFvar* addTerm "PS" (new nrc.fuzzy.TriangleFuzzySet 0.0 .15 .25))
   (?*hotValveChangeFvar* addTerm "PM" (new nrc.fuzzy.TriangleFuzzySet .15 .3 .35))
   (?*hotValveChangeFvar* addTerm "PB" (new nrc.fuzzy.LFuzzySet .25 .5 ?*llf*))
   (?*coldValveChangeFvar* addTerm "NB" (new nrc.fuzzy.RFuzzySet -0.5 -.25 ?*rlf*))
   (?*coldValveChangeFvar* addTerm "NM" (new nrc.fuzzy.TriangleFuzzySet -.35 -.3 -.15))
   (?*coldValveChangeFvar* addTerm "NS" (new nrc.fuzzy.TriangleFuzzySet -.25 -.15 0.0))
   (?*coldValveChangeFvar* addTerm "Z" (new nrc.fuzzy.TriangleFuzzySet -.05 0.0 0.05))
   (?*coldValveChangeFvar* addTerm "PS" (new nrc.fuzzy.TriangleFuzzySet 0.0 .15 .25))
   (?*coldValveChangeFvar* addTerm "PM" (new nrc.fuzzy.TriangleFuzzySet .15 .3 .35))
   (?*coldValveChangeFvar* addTerm "PB" (new nrc.fuzzy.LFuzzySet .25 .5 ?*llf*))
...
(defrule none_none
 ...
 =>
  (assert (change_hv (new nrc.fuzzy.FuzzyValue ?*hotValveChangeFvar* "PS"))
          (change_cv (new nrc.fuzzy.FuzzyValue ?*coldValveChangeFvar* "PM"))
  )
...
(defrule cold_low
 ...
 =>
  (assert (change_hv (new nrc.fuzzy.FuzzyValue ?*hotValveChangeFvar* "PB"))
...
(defrule cold_OK
 ...
 =>
  (assert (change_hv (new nrc.fuzzy.FuzzyValue ?*hotValveChangeFvar* "PM"))
          (change_cv (new nrc.fuzzy.FuzzyValue ?*coldValveChangeFvar* "Z"))
  )
  (bind ?*rulesThatFired* (str-cat ?*rulesThatFired*
...
(defrule OK_low
 ...
 =>
  (assert (change_hv (new nrc.fuzzy.FuzzyValue ?*hotValveChangeFvar* "PS"))
          (change_cv (new nrc.fuzzy.FuzzyValue ?*coldValveChangeFvar* "PS"))
  )
  (bind ?*rulesThatFired* (str-cat ?*rulesThatFired*
...
(defrule OK_strong
  ...
  (flow ?f&:(fuzzy-match ?f "strong"))
 =>
  (assert (change_hv (new nrc.fuzzy.FuzzyValue ?*hotValveChangeFvar* "NS"))
          (change_cv (new nrc.fuzzy.FuzzyValue ?*coldValveChangeFvar* "NS"))
  )
  (bind ?*rulesThatFired* (str-cat ?*rulesThatFired*
...
(defrule hot_low
 ...
 =>
  (assert (change_hv (new nrc.fuzzy.FuzzyValue ?*hotValveChangeFvar* "Z"))
          (change_cv (new nrc.fuzzy.FuzzyValue ?*coldValveChangeFvar* "PB"))
  )
  (bind ?*rulesThatFired* (str-cat ?*rulesThatFired*
...
(defrule hot_OK
  ...
  (flow ?f&:(fuzzy-match ?f "OK"))
 =>
  (assert (change_hv (new nrc.fuzzy.FuzzyValue ?*hotValveChangeFvar* "NM"))
          (change_cv (new nrc.fuzzy.FuzzyValue ?*coldValveChangeFvar* "Z"))
  )
  (bind ?*rulesThatFired* (str-cat ?*rulesThatFired*
...
(defrule hot_strong
  ...
  (flow ?f&:(fuzzy-match ?f "strong"))
 =>
  (assert (change_hv (new nrc.fuzzy.FuzzyValue ?*hotValveChangeFvar* "NB"))
          (change_cv (new nrc.fuzzy.FuzzyValue ?*coldValveChangeFvar* "Z"))
  )
  (bind ?*rulesThatFired* (str-cat ?*rulesThatFired*
